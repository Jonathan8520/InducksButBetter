...
export function TypingIndicator() {
  return (
    <div className="bg-white text-zinc-400 self-start rounded-2xl rounded-tl-none border border-zinc-200 shadow-sm px-4 py-3 flex items-center gap-1.5 animate-spring-pop">
